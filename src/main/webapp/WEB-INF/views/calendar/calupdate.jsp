...
<%
CalParam jcal=(CalParam)request.getAttribute("cp");
...
<input type="hidden" name="seq" value="${cp.seq }">
...
<tr>
	...
	<td style="text-align: left">
		<input type="text" size="60" name='title' value="${cp.title }" />
	</td>
</tr>
<tr>
	<th>일정</th>
...
<tr>
	<th>내용</th>
	<td style="text-align: left"><textarea  name='content' rows="20" cols="60">${cp.content }</textarea></td>
</tr>
<tr>
