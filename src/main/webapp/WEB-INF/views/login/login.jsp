...
<div id="main_wrap">
	<div id="middle_wrap">
		<div id="content_wrap">
			...
			<div class="login_title_warp" style="background-color: white;">
				<div id="_title_image" style=" display: inline; width: 600px; height: 90px">
					<img alt="" src="./image/top_log.png" style="height: 53px">	
				</div>	
			</div>
				...
				<form action="loginAf.do" name="frmFrom" id="_frmFrom" method="post">
					...
					<tr>
						...
						<span>
							...
							<button type="button"  class="btn btn-secondary"  id="_btnLogin">로그인</button>
							<button type="button" class="btn btn-secondary"  id="_btnRegi" >회원가입</button>						
